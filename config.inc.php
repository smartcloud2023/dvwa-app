...
# Define $DBMS explicitly so it's not undefined later
...
$_DVWA = array();
$_DVWA['db_server']   = getenv('DB_SERVER') ?: 'db';          // Docker service name for MySQL
...
$_DVWA['recaptcha_public_key']  = getenv('RECAPTCHA_PUBLIC_KEY') ?: '6LcuzxAsAAAAAPJmJzPG9Gn92xVh6ygs7LQXncMt';
$_DVWA['recaptcha_private_key'] = getenv('RECAPTCHA_PRIVATE_KEY') ?: '6LcuzxAsAAAAAGp47NfCdKLgx_C4bxKnz5XCGOR4';
